...
const NEUTROPHILS_PATTERNS = [
  new RegExp(`[Nn]eu\\w*phil\\w*\\s+(${OCR_NUMBER_TOKEN})`),
  new RegExp(`[Nn]eu\\s*\\w*phil\\w*\\s+(${OCR_NUMBER_TOKEN})`),
  new RegExp(`\\bNEUT\\b[.\\s%]*(${OCR_NUMBER_TOKEN})`, 'i'),
  new RegExp(`\\bNeu\\w{0,15}\\s+(${OCR_NUMBER_TOKEN})`),
];
const EOSINOPHILS_PATTERNS = [
  new RegExp(`[Ee]o\\w*phil\\w*\\s+(${OCR_NUMBER_TOKEN})`),
  new RegExp(`[Ee]o\\s*\\w*phil\\w*\\s+(${OCR_NUMBER_TOKEN})`),
  new RegExp(`\\bEOS\\b[.\\s%]*(${OCR_NUMBER_TOKEN})`, 'i'),
  new RegExp(`\\bEo\\w{0,15}\\s+(${OCR_NUMBER_TOKEN})`),
];
