...
// features, not per-pixel character shapes. Kept modest (JPEG, 1.5x) to keep
// requests small and fast; OpenAI's paid-tier rate limits aren't nearly as
// tight as Groq's free tier was, so this is a cost/latency choice now rather
// than the hard requirement it was when a single oversized image alone could
// exceed Groq's per-minute token budget.
